    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RankTiers", x => x.TierID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopAvatar = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ShopBanner = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ShopFacebook = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ShopTiktok = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ShopInstagram = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shops_CourseCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTierHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserTierHistories_RankTiers_TierID",
                        column: x => x.TierID,
                        principalTable: "RankTiers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PointLedgers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PointLedgers_PointWallets_PointWalletId",
                        column: x => x.PointWalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseProducts_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShipmentItems_OrderDetails_OrderDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonProducts_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseProducts_CourseId_ProductId",
                table: "CourseProducts",
                columns: new[] { "CourseId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseProducts_ProductId",
                table: "CourseProducts",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leaderboards_Code",
                table: "Leaderboards",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LessonProducts_LessonId_ProductId",
                table: "LessonProducts",
                columns: new[] { "LessonId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LessonProducts_ProductId",
                table: "LessonProducts",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentItems_OrderDetailId",
                table: "ShipmentItems",
